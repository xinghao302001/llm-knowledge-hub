...
class ActorCritic(nn.Module):
    ...
    def evaluate_actions(self, obs_b: torch.Tensor, act_b: torch.Tensor):
...
class PPOAgent:
    ...
    def compute_gae(self, last_value: float, done: bool):
    ...
    def collect_rollout(self, env) -> Tuple[float, float]:
        ...
        for _ in range(self.cfg.rollout_steps):
            ...
            if len(step_out) == 5:
                ...
                next_obs, reward, is_terminal, info = step_out
        ...
        self.compute_gae(last_value=last_value, done=False)
